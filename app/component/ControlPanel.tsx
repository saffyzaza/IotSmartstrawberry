...
const ControlPanel: React.FC<ControlPanelProps> = ({ relays, onToggle }) => {
  const controls = [
        ...
        {controls.map((control) => {
          ...
          return (
            <button
              ...
              className={`relative group overflow-hidden flex flex-col items-center justify-center p-5 rounded-2xl border transition-all duration-300 ${
                isActive 
            ...
            >
              ...
              <span className={`text-3xl mb-2 transition-transform duration-300 ${isActive ? 'scale-110 drop-shadow-md' : 'grayscale group-hover:grayscale-0'}`}>
                {control.icon}
              </span>
